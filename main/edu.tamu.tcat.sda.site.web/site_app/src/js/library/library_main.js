define(function (require) {
   ...
   var LibraryLayoutView = require('./views/library_layout_view');

   var BookSearchApp = require('./apps/book_search/book_search_app');
   var WorkInfoApp = require('./apps/work_info/work_info_app');
   var BookReaderApp = require('./apps/book_library/book_reader_app');
   ...
   var ArticleReaderApp = require('./apps/article_library/article_reader_app');


   function initialize(el, config) {

      var layout = new LibraryLayoutView({ el: el });
      layout.render();
