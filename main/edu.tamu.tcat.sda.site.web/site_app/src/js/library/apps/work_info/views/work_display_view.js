define(function (require) {
   ...
   var PublicationInfoView = Marionette.ItemView.extend({
      template: _.partial(nunjucks.render, 'library/biblio/main/publication_info.html'),
      tagName: 'span'
   });


   var VolumeView = Marionette.LayoutView.extend({
      template: _.partial(nunjucks.render, 'library/biblio/main/volume.html'),
      tagName: 'section',
      className: 'volume',
   ...
   var EditionView = Marionette.LayoutView.extend({
      template: _.partial(nunjucks.render, 'library/biblio/main/edition.html'),
      tagName: 'section',
      className: 'edition',
   ...
   var RelationshipView = Marionette.LayoutView.extend({
      template: _.partial(nunjucks.render, 'library/biblio/main/relationship.html'),
      tagName: 'li',
   ...
   var WorkDisplayView = Marionette.LayoutView.extend({
      template: _.partial(nunjucks.render, 'library/biblio/main/work.html'),
      tagName: 'article',
      className: 'work',
