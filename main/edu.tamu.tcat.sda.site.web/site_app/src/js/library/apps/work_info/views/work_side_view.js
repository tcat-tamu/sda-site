define(function (require) {
   ...
   var RelationshipView = Marionette.LayoutView.extend({
      template: _.partial(nunjucks.render, 'library/biblio/side/reln.html'),
      tagName: 'li',
   ...
   var EditionView = Marionette.LayoutView.extend({
      template: _.partial(nunjucks.render, 'library/biblio/side/edition.html'),
      tagName: 'li',
   ...
   var WorkSideView = Marionette.LayoutView.extend({
      template: _.partial(nunjucks.render, 'library/biblio/side/work.html'),
      className: 'work',
