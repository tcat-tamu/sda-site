(function () {
  ...
  /** @ngInject */
  function config($logProvider, $mdThemingProvider, worksRepoProvider, peopleRepoProvider, trcSearchProvider, relnRepoProvider, seeAlsoRepoProvider, sdaSitenavProvider, analyticsProvider) {
    // Enable log
