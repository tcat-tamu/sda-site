(function () {
  ...
  /** @ngInject */
  function ShowWorkController($state, $stateParams, worksRepo, relnRepo, refsRepoFactory, $mdDialog, $mdToast, $q, $timeout, relnEditDialog, copyEditDialog, citationEditDialog) {
    var refsRepo = null;
    var vm = this;
